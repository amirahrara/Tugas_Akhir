...
<head>
    ...
    <link rel="icon" href="../assets/img/logo-B.png" />
...
<body>
                    ...
                    <div class="modal-dialog modal-dialog-aside" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <button class="btn btn-sm btn-secondary" id="btnreading"
                                            data-dismiss="modal">
                                            <i class="fas fa-highlighter"></i> &nbsp; Reading Mask
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <button class="btn btn-sm btn-secondary" id="btnstopanimasi"
                                            data-dismiss="modal">
                                            <i class="fas fa-stop-circle"></i> &nbsp; Stop Animasi
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label for="form-label">Sesuaikan Ukuran Font</label>
                                        <div class="form-group">
                                            <button id="decreaseFontSize" class="btn btn-sm btn-primary">
                                                <i class="fas fa-chevron-down"></i> &nbsp; Turun
                                            </button>
                                            <input type="text" class="btn btn-sm" name="font-sizes"
                                                id="font-sizes" style="width:60px">
                                            <button id="increaseFontSize" class="btn btn-sm btn-primary">
                                                <i class="fas fa-chevron-up"></i> &nbsp; Naik
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="footer__about">
                                    ...
                                    <a href="https://wa.me/6281232355887"><i class='fab fa-whatsapp fa-lg'></i></a>
    ...
    <script type="text/javascript">
        ...
        //             linear-gradient(to bottom, rgba(0, 0, 0, 0.7) 0%, rgba(0, 0, 0, 0.7) ${transparentPercentage}%, transparent ${transparentPercentage}%, transparent ${transparentPercentage + 25}%, rgba(0, 0, 0, 0.7) ${transparentPercentage + 2}%, rgba(0, 0, 0, 0.7) 100%)`;
            ...
            // Event listener untuk menghapus nilai dari localStorage saat halaman di-reload atau ditutup
            window.addEventListener('beforeunload', function() {
                localStorage.removeItem('fontSizeIncrease');
            });

            // Inisialisasi saat halaman dimuat
            window.addEventListener('load', function() {
                // Jika ada nilai tersimpan di localStorage, hapus nilai tersebut
                localStorage.removeItem('fontSizeIncrease');
            });
