...
>>>>>>> 70e7e3be608c6988c5f0f92ce9f60944b320a56b
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <button class="btn btn-outline-dark" id="btnreading" data-dismiss="modal">Reading
                                    Mask</button>
                                <button class="btn btn-outline-dark" id="btnstopanimasi" data-dismiss="modal">Stop
                                    Animasi</button>
                                <button class="btn btn-outline-dark" id="btnfont" data-dismiss="modal">Adjust Ukuran
                                    Font</button>
                            </div>
...
>>>>>>> 70e7e3be608c6988c5f0f92ce9f60944b320a56b
    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            // Ambil elemen target
            var target = document.getElementById('wrappers');
            ...
            box.style.width = '100%';
            box.style.height = '20%';
            box.style.backgroundColor = 'rgba(255, 255, 255, 0.2)'; // Warna putih dengan transparansi
            box.style.position = 'fixed';
            box.style.top = '0';
            box.style.left = '50%';
            box.style.transform = 'translate(-50%, -50%)';
            box.style.zIndex = '999'; // Menempatkan di atas latar belakang
            document.body.appendChild(box); // Menambahkan kotak putih ke dalam body

            target.addEventListener('mousemove', function(event) {
                // Mengatur posisi vertikal kotak putih berdasarkan posisi mouse
