                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="assets/img/shop-details/kemeja2.png">
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="assets/img/shop-details/kemeja1.png">
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="assets/img/shop-details/kemeja3.png">
                                    </div>
                                </a>
                            </li>
                            {{-- <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="assets/img/shop-details/kemeja2.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <div class="product__details__btns__option">
                                <a href="#"><i class="fa fa-heart"></i> Tambah ke favorit</a>
                                <a href="#"><img src="/assets/img/icon/cart.png" alt=""> Tambah ke keranjang</a>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="product__details__tab">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tabs-6" role="tab">Rating & Review</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tabs-7" role="tab">Spesifikasi</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tabs-5" role="tabpanel">
                                    <div class="product__details__tab__content">
                                        ...
                                        <div class="product__details__tab__content__item">
                                            ...
                                            <ul>
                                                <p><span>LD:</span> Lingkar Dada</p>
                                                <p><span>LP:</span> Lingkar Pinggang</p>
                                                <p><span>LPI:</span> Lingkar Pinggul</p>
                                            </ul>
                                            <br>
                                            <ul>
                                ...
                                <div class="tab-pane" id="tabs-6" role="tabpanel">
                                    <div class="product__details__tab__content">
                                        <div class="product__details__tab__content__item">
                                            <h5>Meli</h5>
                                            <p style="font-size: 80%">30/11/2024-07.00</p>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                            ...
                                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officia, ullam. Quo maxime distinctio consequatur laborum ipsum? Quos beatae quae cupiditate suscipit veniam labore, accusantium eos ipsa. Aspernatur praesentium qui quisquam.</p>
                                        </div>
                                        <div class="product__details__tab__content__item">
                                            <h5>Ira</h5>
                                            <p style="font-size: 80%">25/10/2024-09.36</p>
                                            <div class="rating">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
